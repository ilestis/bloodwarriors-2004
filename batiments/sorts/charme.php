				...
				if($res->peasant > $CONF['paysans_min'])
				{
					...
					if($resp->peasant+$Variable <= $Max)
					{
						...
						{//Retour OK, pas de protection
							...
							//Message
							$MessageS = "La province ".$_SESSION['name_province']." du joueur ".$Joueur->pseudo." vous a volé ".$Variable." paysans grâce au sort de ".$Nom.", votre province ".$res->name." se trouve dérobée!";
							$Message = bw_info("Vous avez volé ".$Variable." paysans à la province ".$res->name.".<br />");
