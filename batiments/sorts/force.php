...
if(sort_available($res->batint, $res->race, $Joueur->race)) {
{
			...
			if ((($Joueur->ally_id != 0) && ($Joueur->ally_id == $res['ally_id'])) || $res['id'] == $_SESSION['id_joueur']) 
			{
				...
				{	
					...
					{//On a passé
						...
						$Message = bw_info("La Force accompagne à présent les unités de la province ".$res['name']." pour une durée de ".$Temps." heures!<br />\n");
					}
					else
					{
	...
	echo "Invoque la Force sur les unités de la province ciblée, pour un bonus de ".$Variable." pour une durée de ".$Temps." heures.<br />\n";
	...
	echo "<INPUT TYPE=\"submit\" value=\"Lancer une Force pour ".$Prix." magie.\">\n";
